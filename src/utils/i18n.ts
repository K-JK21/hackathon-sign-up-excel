...
export const translations = {
  ky: {
    ...
    hero: {
      ...
      date: '20-22-май, 2025',
      dateSub: 'Хакатон күндөрү: 20-майда старт, 21-майда долбоорлорду сынап көрүү, 22-майда жыйынтыктарды чыгаруу.',
  ...
  ru: {
    ...
    success: {
      ...
      subtitle: 'Спаси��о за регистрацию на хакатон Жаңырган Акы��. Мы с нетерпением ждем встречи с вами!',
