        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-500">{t("index.buildSub")}</p>
            </div>
            <div className="text-center">
              <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-violet-100 mb-4">
              ...
              <p className="text-gray-500">{t("index.connectSub")}</p>
            </div>
            <div className="text-center">
              <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-violet-100 mb-4">
              ...
              <p className="text-gray-500">{t("index.learnSub")}</p>
            </div>
          </div>
