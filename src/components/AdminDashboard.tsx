...
export default function AdminDashboard() {
  ...
  const handleDelete = (id: string) => {
    if (deleteParticipant(id)) {
      ...
      toast({
        description:
          t("admin.deleteSuccess") || "Participant deleted successfully",
      });
    } else {
      toast({
        variant: "destructive",
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>{t("admin.tableHeaders.teamName")}</TableHead>
                  <TableHead>{t("admin.tableHeaders.teamsize")}</TableHead>
                  <TableHead>{t("admin.tableHeaders.teamMembers")}</TableHead>
                  {/* <TableHead>{t("admin.tableHeaders.teamStatus")}</TableHead> */}
                  <TableHead>
                    {t("admin.tableHeaders.registrationDate")}
                  </TableHead>
              ...
              <TableBody>
                {filteredParticipants.map((participant) => (
                  <TableRow key={participant.id}>
                    ...
                    <TableCell>{participant.teamSize}</TableCell>
                    <TableCell>{participant.teamMembers}</TableCell>
                    <TableCell>
                      {new Date(
