        ...
        <div className="mt-20">
          <div className="grid gap-8 md:grid-cols-3">
            <div className="rounded-lg bg-white p-6 shadow-md">
              ...
              <h3 className="mb-2 text-xl font-medium text-slate-900">{t('hero.date')}</h3>
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              ...
              <h3 className="mb-2 text-xl font-medium text-slate-900">{t('hero.participants')}</h3>
              <p className="text-slate-600">
                {t('hero.participantsSub')}
              </p>
            </div>
            <div className="rounded-lg bg-white p-6 shadow-md">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-violet-100">
              ...
              <h3 className="mb-2 text-xl font-medium text-slate-900">{t('hero.prize')}</h3>
              <p className="text-slate-600">
                {t('hero.prizeSub')}
              </p>
            </div>
